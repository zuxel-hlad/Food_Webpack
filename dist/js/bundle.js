...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_4__.getResource)("http://localhost:3000/menu").then(function (data) {
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal */ "./src/js/modules/modal.js");
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/services */ "./src/js/services/services.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.showModal)(".modal", modalTimerId);
...
/* harmony import */ var core_js_modules_es_array_unscopables_flat_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! core-js/modules/es.array.unscopables.flat.js */ "./node_modules/core-js/modules/es.array.unscopables.flat.js");
/* harmony import */ var core_js_modules_es_array_unscopables_flat_js__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_unscopables_flat_js__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var core_js_modules_es_date_now_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! core-js/modules/es.date.now.js */ "./node_modules/core-js/modules/es.date.now.js");
/* harmony import */ var core_js_modules_es_date_now_js__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_date_now_js__WEBPACK_IMPORTED_MODULE_17__);
...
/* harmony import */ var core_js_modules_es_string_trim_js__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! core-js/modules/es.string.trim.js */ "./node_modules/core-js/modules/es.string.trim.js");
/* harmony import */ var core_js_modules_es_string_trim_js__WEBPACK_IMPORTED_MODULE_34___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_string_trim_js__WEBPACK_IMPORTED_MODULE_34__);
...
var showModal = function showModal(modalSelector, modalTimerId) {
  var modal = document.querySelector(modalSelector);
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  modalTrigger.forEach(function (btn) {
    btn.addEventListener("click", function () {
      return showModal(modalSelector, modalTimerId);
    });
  });
...
function slider(_ref) {
  ...
  if (sliderItems.length < 10) {
    sliderTotal.textContent = "0".concat(sliderItems.length);
    sliderCurrent.textContent = "0".concat(slideIndex);
  } else {
  ...
  var sliderDots = document.createElement("ol"),
      dots = [];
  ...
  var addDotsOpacity = function addDotsOpacity() {
  ...
  var deleteNotDigets = function deleteNotDigets(str) {
    return +str.replace(/\D/g, "");
  };

  var checkSliderCurrent = function checkSliderCurrent() {
    if (sliderItems.length < 10) {
      sliderCurrent.textContent = "0".concat(slideIndex);
    } else {
      sliderCurrent.textContent = slideIndex;
...
/* harmony import */ var _modules_jQuery__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/jQuery */ "./src/js/modules/jQuery.js");
/* harmony import */ var _modules_btnUp__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/btnUp */ "./src/js/modules/btnUp.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.showModal)(".modal", modalTimerId);
  }, 50000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_2__.default)(".tabheader__item", ".tabcontent", ".tabheader__items", "tabheader__item_active");
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)(".timer", "2021-03-01");
  ...
  (0,_modules_jQuery__WEBPACK_IMPORTED_MODULE_9__.default)();
  (0,_modules_btnUp__WEBPACK_IMPORTED_MODULE_10__.default)();
});
